...
6. **Finale erleben:** Final Theater, Champion, Crowd Mood, Rivalenstory und Reward Bits.
7. **Reward Draft:** Ein Reward wird gewaehlt und zahlt Mastery aus.
8. **Rematch:** Direkt neue Strategie oder neues Event ausprobieren.

## Design

- **Fantasy:** Cyber-coliseum broadcast with neon circuits, announcer drama and tactical preparation.
- **Interaktion:** Strategy Cards, event priming, reveal buttons, match spotlight, reward claim.
